...
public class MiniGoParser extends Parser {
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			System.out.println("201402406 Rule 0");
			}
		}
	...
	public final DeclContext decl() throws RecognitionException {
		...
		try {
			...
			case VAR:
				...
				setState(43);
				var_decl();
				System.out.println("201402406 Rule 1-0");
				}
				break;
			case FUNC:
				...
				setState(46);
				fun_decl();
				System.out.println("201402406 Rule 1-1");
				}
				break;
			default:
	...
	public final Var_declContext var_decl() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(53);
				type_spec();
				System.out.println("201402406 Rule 2-0");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(60);
				match(LITERAL);
				System.out.println("201402406 Rule 2-1");
				}
				break;
			case 3:
				...
				setState(68);
				type_spec();
				System.out.println("201402406 Rule 2-2");
				}
				break;
			}
		}
	...
	public final Dec_specContext dec_spec() throws RecognitionException {
		...
		try {
			...
			setState(73);
			match(VAR);
			System.out.println("201402406 Rule 3");
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Type_specContext type_spec() throws RecognitionException {
		...
		try {
			...
			case INT:
				...
				setState(76);
				match(INT);
				System.out.println("201402406 Rule 4-0");
				}
				break;
			case EOF:
			case T__0:
			...
			case LITERAL:
				enterOuterAlt(_localctx, 2);
				{
				System.out.println("201402406 Rule 4-1");
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Fun_declContext fun_decl() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(87);
				compound_stmt();
				System.out.println("201402406 Rule 5-0");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(100);
				compound_stmt();
				System.out.println("201402406 Rule 5-1");
				}
				break;
			}
		}
	...
	public final ParamsContext params() throws RecognitionException {
		...
		try {
			...
			case IDENT:
				...
				System.out.println("201402406 Rule 6-0");
				}
				break;
			case T__4:
				enterOuterAlt(_localctx, 2);
				{
				System.out.println("201402406 Rule 6-1");
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final ParamContext param() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(118);
				match(IDENT);
				System.out.println("201402406 Rule 7-0");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(121);
				type_spec();
				System.out.println("201402406 Rule 7-1");
				}
				break;
			}
		}
	...
	public final StmtContext stmt() throws RecognitionException {
		...
		try {
			...
			case LITERAL:
				...
				setState(126);
				expr_stmt();
				System.out.println("201402406 Rule 8-0");
				}
				break;
			case T__6:
				enterOuterAlt(_localctx, 2);
				...
				setState(129);
				compound_stmt();
				System.out.println("201402406 Rule 8-1");
				}
				break;
			case IF:
				enterOuterAlt(_localctx, 3);
				...
				setState(132);
				if_stmt();
				System.out.println("201402406 Rule 8-2");
				}
				break;
			case FOR:
				...
				setState(135);
				for_stmt();
				System.out.println("201402406 Rule 8-3");
				}
				break;
			case RETURN:
				...
				setState(138);
				return_stmt();
				System.out.println("201402406 Rule 8-4");
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Expr_stmtContext expr_stmt() throws RecognitionException {
		...
		try {
			...
			setState(143);
			expr(0);
			System.out.println("201402406 Rule 9");
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final For_stmtContext for_stmt() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(148);
				stmt();
				System.out.println("201402406 Rule 10-0");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(153);
				stmt();
				System.out.println("201402406 Rule 10-1");
				}
				break;
			}
		}
	...
	public final Compound_stmtContext compound_stmt() throws RecognitionException {
		...
		try {
			...
			setState(171);
			match(T__7);
			System.out.println("201402406 Rule 11");
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Local_declContext local_decl() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(176);
				type_spec();
				System.out.println("201402406 Rule 12-0");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(183);
				match(LITERAL);
				System.out.println("201402406 Rule 12-1");
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				...
				setState(191);
				type_spec();
				System.out.println("201402406 Rule 12-2");
				}
				break;
			}
		}
	...
	public final If_stmtContext if_stmt() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(198);
				stmt();
				System.out.println("201402406 Rule 13-0");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(205);
				stmt();
				System.out.println("201402406 Rule 13-1");
				}
				break;
			}
		}
	...
	public final Return_stmtContext return_stmt() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(211);
				expr(0);
				System.out.println("201402406 Rule 14-0");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				setState(217);
				expr(0);
				System.out.println("201402406 Rule 14-1");
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				...
				setState(220);
				match(RETURN);
				System.out.println("201402406 Rule 14-2");
				}
				break;
			}
		}
	...
	public final Loop_exprContext loop_expr() throws RecognitionException {
		...
		try {
			...
			System.out.println("201402406 Rule 15");
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				System.out.println("201402406 Rule 16-0");
				}
				break;
			case 2:
				{
				...
				setState(237);
				match(T__4);
				System.out.println("201402406 Rule 16-1");
				}
				break;
			case 3:
				{
				...
				setState(243);
				match(T__2);
				System.out.println("201402406 Rule 16-2");
				}
				break;
			case 4:
				{
				...
				setState(249);
				match(T__4);
				System.out.println("201402406 Rule 16-3");
				}
				break;
			case 5:
				{
				...
				setState(257);
				match(T__4);
				System.out.println("201402406 Rule 16-4");
				}
				break;
			case 6:
				{
				...
				setState(261);
				expr(6);
				System.out.println("201402406 Rule 16-5");
				}
				break;
			case 7:
				{
				...
				setState(266);
				expr(2);
				System.out.println("201402406 Rule 16-9");
				}
				break;
			case 8:
				{
				...
				setState(274);
				expr(1);
				System.out.println("201402406 Rule 16-10");
				}
				break;
			}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						System.out.println("201402406 Rule 16-6");
						}
						break;
					case 2:
						{
						...
						System.out.println("201402406 Rule 16-7");
						}
						break;
					case 3:
						{
						...
						System.out.println("201402406 Rule 16-8");
						}
						break;
					}
					} 
	...
	public final ArgsContext args() throws RecognitionException {
		...
		try {
			...
			case LITERAL:
				...
				System.out.println("201402406 Rule 17-0");
				}
				break;
			case T__4:
				enterOuterAlt(_localctx, 2);
				{
				System.out.println("201402406 Rule 17-1");
				}
				break;
			default:
				throw new NoViableAltException(this);
